    ...
    >
      <Box>
        <Grid
          ...
          spacing={2}
          sx={{justifyContent:{md: 'flex-start', lg: 'center'}, display: 'flex', maxWidth: '80%'}}
        >
          <Grid item xs={3} sx={{ marginLeft: {md: 5, lg: 0}}}>
            ...
            >
              ...
              <Typography variant="h6" sx={{fontSize:{ xs: 10, md:14, lg: 20}}}>{bread}</Typography>
              ...
              <a href={`${github}`}>
              <img
                style={{ height: "30px", borderRadius: "25px", paddingTop: 10 }}
                src={githubLogo}
                ></img>
              </a>
              </Box>
          ...
          <Grid item xs={2} sx={{ width: "100%" }}>
            <Paper elevation="10" sx={{ borderRadius: "25px", width: {md: 650, lg: 800, } }}>
                <Box>
                  <img
                    src={image}
